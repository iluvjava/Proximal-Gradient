...
\section{TV Minimizations}
    ...
    %         C\in \mathbb R^{N\times (N + 1)} \text{ be upper bi-diagonal with }(1/h_i, -1/h_i)
    %         \\
    %         &= \frac{1}{2}\left(
    ...
    %     In practice we should the dual proble, given by \footnote{See my report for the omitted details. }
    %     \begin{align*}
    ...
    %     \begin{align*}
    %         - g(-\lambda) =
    %         -\frac{1}{2} \Vert -C^T\lambda\Vert^2_{D^{-1}} - 
