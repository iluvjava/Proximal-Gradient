...
\section{Nesterov's Lower Bound Clarified}\label{sec:optimal_lower_bound}
    ...
    \subsection{First-order Method}
        ...
        We came up with the following example to illustrate the definition. 
    ...
    \subsection{Lower Complexity Bounds for $L$-Lipschitz Smooth Function}
        ...
        \begin{remark}
            ...
            \par
            We are unsure how the theorem generalizes to infinite dimension Hilbert space due to the assumption of $x^*$ and the function Nesterov used in his proof. 
        \end{remark}
