...
\section{FISTA Under Strong Convexity}\label{sec:fista_strong_convexity}
    ...
    \subsection{Convergence Claim}
        ...
        \begin{prop}
            ...
            $t_{k + 1} = 1 + \frac{t_k^2(1 - q)}{t_k + 1}$, and $t_{k + 1} \ge t_k + 1 - t_k^2q$, for all $k\ge 0$, then \hyperref[prop:vfista-generic-convergence]{proposition \ref*{prop:vfista-generic-convergence}} stays stays true. 
